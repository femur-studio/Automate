...
const CONTRAST_WARNING_COLORS: (keyof typeof colors)[] = ["amber", "cyan", "green", "lime", "yellow", "emerald"]
...
export function BaseHubThemeProvider({ theme }: { theme: BaseHubTheme }) {
  const accent = colors[theme.accent] || colors.emerald
  ...
  css.push(`--success-rgb: 16, 185, 129;`)
