      ...
      <Section className="py-16 border-y bg-gray-50/50 dark:bg-gray-900/20">
        <div className="text-center space-y-8">
          ...
          <div className="flex flex-wrap justify-center items-center gap-8 lg:gap-16">
            <img
              src="/logos/n8n-color.png"
              alt="n8n logo"
              className="h-20 w-auto transition-opacity hover:opacity-80"
            />
            <img
              src="/logos/zapier-text.png"
              alt="Zapier logo"
              className="h-20 w-AUTO transition-opacity hover:opacity-80"
            />
            <img
              src="/logos/idxNzpLjOz_1755917334136.jpeg"
              alt="pipedream logo"
              className="h-20 w-auto transition-opacity hover:opacity-80 rounded-xl"
            />
            <img
              src="/logos/idvndbnyVK_logos.png"
              alt="Relay.app logo"
              className="h-20 w-auto transition-opacity hover:opacity-80 "
            />
          </div>
